...
# TODO!
#rails generate model Studio (executed in terminal)
#added columns in migrate (please check db -> migrate)
#rails db:migrate (executed in terminal)
#puts "studios: #{Studio.all.count}" (check)

#rails generate model Movie (executed in terminal)
#added columns in migrate (please check db -> migrate)
#rails db:migrate (executed in terminal)
#puts "movies: #{Movie.all.count}" (check)

#rails generate model Actor (executed in terminal)
#added columns in migrate (please check db -> migrate)
#rails db:migrate (executed in terminal)
#puts "actors: #{Actor.all.count}" (check)

#rails generate model Role (executed in terminal)
#added columns in migrate (please check db -> migrate)
#rails db:migrate (executed in terminal)
#puts "roles: #{Role.all.count}" (check)
...
movie_3 = Movie.find_by({"title" => "The Dark Knight Rises"})
actor_11 = Actor.find_by({"name" => "Ann Hathaway"})
new_role = Role.new
new_role["movie_id"] = movie_3["id"]
new_role["actor_id"] = actor_11["id"]
new_role["character_name"] = "Selena Kyle"
new_role.save
